...
export const projects: readonly Project[] = [
  {
    slug: "restaurant-gout-authentique",
    title: "Le Goût Authentique",
    sector: "Restaurant",
    image: "/assets/portfolio-restaurant.webp",
    alt: "Concept de site gastronomique Le Goût Authentique, présenté dans une interface sombre",
  ...
  {
    slug: "clinique-dentaire-lumiere",
    title: "Clinique Dentaire Lumière",
    sector: "Santé",
    image: "/assets/portfolio-dentaire.webp",
    alt: "Concept de site pour la Clinique Dentaire Lumière affiché sur un ordinateur dans un cabinet sombre",
    summary: "Une interface rassurante qui rend l’expertise, les soins et la prise de rendez-vous faciles à comprendre.",
    brief:
      "Concevoir un univers digital premium pour un cabinet dentaire fictif sans sacrifier la clarté attendue dans le secteur de la santé.",
    solution:
  ...
  {
    slug: "residences-horizon",
    title: "Résidences Horizon",
    sector: "Immobilier",
    image: "/assets/portfolio-immobilier.webp",
    alt: "Concept de site immobilier Résidences Horizon présentant une résidence contemporaine de nuit",
  ...
  },
  {
    ...
    alt: "Concept de site Maison Éclat pour un institut de beauté premium",
    summary: "Un langage de marque minimal et sensoriel, conçu pour faire ressentir la qualité avant le premier rendez-vous.",
    brief:
      "Définir une expérience en ligne premium pour un institut de beauté fictif, avec une découverte simple des prestations.",
    solution:
